/* idb.js — لایه‌ی دسترسی به دیتابیس IndexedDB برای اپ مدیریت مشتری
   جدول‌ها: customers, products, sales, conversations, payments (+ media برای رسانه‌ی محصولات)
   هر رکورد دارای کلید خودکار عددی id است؛ شناسه‌ی نمایشی (C-0001 و ...) در app.js ساخته می‌شود. */

const DB_NAME = 'crm-db';
const DB_VERSION = 3;
const STORES = ['customers', 'products', 'sales', 'conversations', 'payments'];
const ALL_STORES = ['customers', 'products', 'sales', 'conversations', 'payments', 'media'];
...
function openDB() {
  ...
  _dbPromise = new Promise((resolve, reject) => {
    ...
    req.onupgradeneeded = (e) => {
      ...
      /* واریزی‌ها (فعلاً ثبت دستی؛ در آینده منبع sms نیز اضافه می‌شود) */
